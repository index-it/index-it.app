<template>
  <div class="h-full flex flex-col items-center justify-center">
    <div
        ...
        class="fixed z-10 bottom-2 md:bottom-[7%] rounded-lg py-5 px-6 mb-4 text-base mb-3 transition-opacity transition-all ease-in-out duration-500"
    ...
    <form @submit.prevent class="w-10/12  md:w-auto text-white flex items-center content-center flex-col md:flex-row bg-stone-700 hover:bg-stone-700/95 text-lg md:text-xl mt-20 rounded-md p-2">
