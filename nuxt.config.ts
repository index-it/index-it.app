...
export default defineNuxtConfig({
   head: {
      ...
      meta: [
         ...
         { name: 'keywords', content: 'todo list, to-do, list, task, to-do list, todo app, index, todolist' },
         { name: 'theme-color', content: '#FFFFFF' },
         { name: 'author', content: 'Giulio Pimenoff Verdolin (https://giuliopime.dev)' },
         ...
         { name: 'twitter:image', content: 'https://index-it.app/logo.png' },
